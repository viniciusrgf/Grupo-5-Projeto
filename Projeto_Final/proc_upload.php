...
<html lang="pt-br">
	<head>
		<meta charset="utf-8">
		<meta http-equiv="refresh" content="1; URL=https://kapinawa.tk/sistema/upload_imagem.php "/>
	</head>
	<body>
...
!-->
		...
		<?php
			...
			if(array_search($extensao, $_UP['extensoes'])=== false){		
				echo "
					<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://kapinawa.tk/upload_imagem.php'>
			...
			//O arquivo passou em todas as verificações, hora de tentar move-lo para a pasta foto
				...
				if(move_uploaded_file($_FILES['arquivo']['tmp_name'], $_UP['pasta']. $nome_final)){
					...
					nome_imagem,descricao) VALUES('$nome_final','$descricao')");
					echo "
						<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://kapinawa.tk/sistema/upload_imagem.php'>
						<script type=\"text/javascript\">
